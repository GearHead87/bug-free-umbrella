...
(function() {
  ...
  const utils = {
    log: (message, data = null) => {
      console.log(`[AusPricing] ${message}`, data || '');
    },

    error: (message, error = null) => {
      console.error(`[AusPricing] ${message}`, error || '');
    },
  ...
  const dom = {
    ...
    updateBrandingPricing: (pricing) => {
      // Update main price "USD 897" to "A$1500"
    ...
    updateBrandVideoPricing: (pricing) => {
      // Update main price "USD 1279" to "A$3500"
      ...
      if (brandVideoHeader) {
        ...
        // Monthly price stays the same as branding in this plan
    ...
    updateVideoPricing: (pricing) => {
      // Update main price "USD 997" to "A$2500"
  ...
  const pricingSystem = {
    ...
    init: async () => {
      utils.log('Initializing Australia pricing system');
    ...
    applyCountryPricing: (countryData) => {
      ...
      if (countryCode && countryCode.toUpperCase() === 'AU') {
        ...
        utils.log('Non-Australia country - keeping default USD pricing');
